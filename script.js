// Product data
  ...
  var products = [
    ...
    {id: 19, name: "Đời ngắn đừng ngủ dài", author: "Robin Sharma", year: 2016, price: 194000, img: "sanpham/sp19.jpg", desc: "Tập hợp những bài học truyền cảm hứng, giúp người đọc sống có mục tiêu, hành động hiệu quả và tạo ra cuộc đời ý nghĩa. Dành cho những ai đang trì hoãn và cần bứt phá bản thân.", category: "kynang"},
    {id: 20, name: "Đọc vị bất kỳ ai", author: "David J. Lieberman", year: 2007, price: 127000, img: "sanpham/sp20.jpg", desc: "Cuốn sách hướng dẫn kỹ năng nhận biết suy nghĩ và ý định thật sự của người khác thông qua quan sát hành vi. Ứng dụng tốt trong đàm phán, giao tiếp, tuyển dụng và quản trị con người.", category: "tamly"}
  ];
